...
const button = document.getElementById("irisToggle");
...
button.addEventListener("click", () => {
  ...
  chart.classList.toggle("with-iris", irisActive);
  button.classList.toggle("is-active", irisActive);

  if (irisActive) {
    button.textContent = "Met IRIS";
    futureValue.textContent = "10%";
    statusText.innerHTML =
      'Status: <span>met IRIS</span> wordt de strategische “Day After Tomorrow”-ruimte ingevuld.';
  } else {
    button.textContent = "Zonder IRIS";
    futureValue.textContent = "0%";
    statusText.innerHTML =
      'Status: <span>zonder IRIS</span> blijft de “Day After Tomorrow”-ruimte onbenut.';
  }
});
